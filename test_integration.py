...
class TestSyncIntegration:
    ...
    def test_full_sync_workflow_with_state_persistence(self, mock_mastodon_class, mock_bluesky_class):
    ...
    def test_sync_state_persistence_across_instances(self):
        ...
        assert sync_state2.get_mastodon_id_for_bluesky_post("at://test-uri") == "mastodon-123"
        ...
        facets = [
            {
                ...
                "features": [{"$type": "app.bsky.richtext.facet#tag", "tag": "library"}]
            },
            {
